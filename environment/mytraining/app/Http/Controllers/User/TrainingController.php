...
class TrainingController extends Controller
{
    ...
    public function home(Request $request)
    {
      ...
      // 不明
      // $personalcontents = PersonalContent::select('trainday_id')->get();
      // 不明
      return view('home',
    ...
    // $personalcontents = PersonalContent::select('trainday_id')->get();
     if ($traindayview != ''){
      ...
      return view('user.main.achievement', ['traincontents'=>$traincontents,//'personalcontents'=>$personalcontents,//
      'weeks'=> $params["weeks"],'prev'=> $params["prev"],
