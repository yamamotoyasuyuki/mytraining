...
<div class="homelayout">
    ...
    @endforeach
    <form action="{{action('User\TrainingController@home')}}" method="get">
        <div class="graph-div">
    ...
    <input type="hidden" name=targetPostCategory value="{{ $targetPostCategory ? $targetPostCategory->name : ""}}" id="hidden2">
</div>
